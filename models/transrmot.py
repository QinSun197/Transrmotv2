...
class TransRMOT(nn.Module):
    def __init__(self, backbone, transformer, num_classes, num_queries, num_feature_levels, criterion, track_embed,
        ...
        # loaded local model
        self.tokenizer = RobertaTokenizerFast.from_pretrained('/home/sq_2023/try/RMOT/weights/roberta-base/',
                                                              local_files_only=True)
        self.text_encoder = RobertaModel.from_pretrained('/home/sq_2023/try/RMOT/weights/roberta-base/',
                                                         local_files_only=True)
